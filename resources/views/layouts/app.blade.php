            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('attendace_sheet.index') ? 'active' : '' }}" href="{{ route('attendace_sheet.index') }}">Attendace Sheet</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('attendace_report.index') ? 'active' : '' }}" href="{{ route('attendace_report.index') }}">Attendace Report</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('it_department.index') ? 'active' : '' }}" href="{{ route('it_department.index') }}">IT Department</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('sale_department.index') ? 'active' : '' }}" href="{{ route('sale_department.index') }}">Sale Department</a>
                        </li>
                    </ul>
