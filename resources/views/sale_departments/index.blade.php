                                        ...
                                        <td>
                                            @if ($user->day_1 === '1')
                                                <button 
                                                    ...
                                                    data-name="mission_requested"
                                                    name="day_1"
                                                    {{ $sale && $team_leader || $sale && $ceo || $sale && $cfo || $sale && $hr ?'':'disabled' }}
                                            ...
                                            @elseif($user->day_1 === '0')
                                                <button 
                                                    ...
                                                    name="day_1"
                                                    {{ $sale && $team_leader || $sale && $cfo || $sale && $hr ?'':'disabled' }}
